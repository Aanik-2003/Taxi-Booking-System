...
class AdminDashboard(tk.Tk):
    def __init__(self, admin_id, first_name):
        ...
        self.add_driver_btn = tk.Button(self.frame1, width=12, text="Add Driver", bg="#212121", fg="green",
                                        command=self.on_driver_btn)
        self.add_driver_btn.place(x=5, y=5)

        self.add_emp_btn = tk.Button(self.frame1, width=12, text="Add Employee", bg="#212121", fg="green",
                                     command=self.on_emp_btn)
        self.add_emp_btn.place(x=5, y=45)

        self.booking_btn = tk.Button(self.frame1, width=12, text="Booking", bg="#212121", fg="lightblue",
                                     command=self.on_booking_btn)
...
class CustomFrame(ttk.Frame):
    ...
    def booking_frame(self, admin_id):
        ...
        self.confirm_btn.place(x=340, y=170)
        self.cancel_btn = tk.Button(self, text="CANCEL", bg="#212121", fg="red", command=self.on_cancel_btn)
        self.cancel_btn.place(x=420, y=170)

        self.list_opt = ["All", "Pending", "Confirmed", "Cancelled"]
        self.x = tk.IntVar()
        ...
        for index in range(len(self.list_opt)):
            ...
            radio_btn.place(x=index * 80, y=175)
        ...
        # Set manual column headings and widths
        headings_and_widths = [("Name", 45), ("PickUp Point", 90), ("DropOff Point", 90), ("PickUp Time", 90),
                               ("Status", 67), ("Driver", 50)]
